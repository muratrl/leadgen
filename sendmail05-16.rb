...
I was running through a list of homes, and came across yours at #{row[4]}.  I ran a brief analysis to get an initial idea of what kind of vacation rental income we'd be able to generate, and came up with a range of #{row[5]} and #{row[6]}.  I'd even be willing to offer a guarantee on it.
