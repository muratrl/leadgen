...
Mail.deliver do
     ...
     body "Hi #{row[1]}- sorry to bug you again.  I just wanted to flag the email I sent to you on Tuesday.
...
My name is Scott and my company, rentLEVER, is the fastest growing vacation rental manager in Lake Tahoe. Our unique approach results in as much as 2X greater profit for our home owners, while reducing management fees to just 18%, and maintaining the highest standards for guest quality and care for your home.
